    ...
    <section className="max-w-7xl mx-auto border-b-2 mt-20" id="about">
        ...
        <div className="flex flex-col items-center lg:space-x-8 mx-4 mb-20">
            <div className=" mb-8 lg:mb-0">
                <img src={aboutImage} alt="About SAEHOME" className=" w-full h-auto" />
            </div>
            <p className=" text-lg lg:text-3xl font-light text-center lg:text-left max-w-5xl mx-auto mt-8">
                perumahan ini dekat dengan pelayana public seperti rumah sakit, sekolah, jalan tol, pusat pembelanjaan dan mempunyai fasilitas yang memadai dan akses jalan sangat strategis 
            </p>
        </div>
    </section>
  )
