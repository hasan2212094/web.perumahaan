...
const Reviews = () => {
  ...
  <section className=" max-w-7xl mx-auto border-b-2" id="reviews">
    <div className="my2-0">
        ...
        <p className="max-2xl text-lg mb-12 text-center mx-auto">
            {REVIEWS.text}
        </p>
        <div className="flex flex-wrap justify-center">
            {REVIEWS.reviews.map((review, index) =>(
                <div key={index} className="mt-10 flex flex-col items-center justify-center rounded-2xl border broder-neutral-300 p-10 mx-2 max-w-xs">
